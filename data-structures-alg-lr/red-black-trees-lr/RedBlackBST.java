...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        // System.out.println("This exercise has no main method. Use `./gradlew test` to run the unit tests, or write your own tests in the main method of RedBlackBST.java.");
        System.out.println("""
            This main method allows you to type multiple strings, which are
            added to a red-black BST. Press Ctrl+D when you're done, and the items added
            will be printed via an in-order traversal (including a number
            indicating the order it was added in). You can use `./gradlew test`
            to run the unit tests, or write your own additional tests in the
            main method of BST.java.
            """);
