...
Welcome to my portfolio of completed coursework and projects during my time as a Computer Science student at the University of Pittsburgh. This repository showcases a range of technical skills developed across disciplines such as algorithms, data analysis, web development, and computer architecture.

Below is an overview of the project folders included in this repository:
...
1. **Search Algorithms for the 8-Puzzle**  
   Investigates search strategies like **BFS**, BFS with pruning, and limited **DFS** to solve the classic sliding puzzle. Evaluates performance in terms of optimality and efficiency.

2. **Logical Inference Engine**  
   Implements a reasoning system using **forward and backward chaining**. Proves a series of logical theorems by incrementally expanding a list of known facts based on inference rules.
...
If you have any questions or would like to learn more about any of these projects, feel free to email me at laurelaine9@gmail.com.
